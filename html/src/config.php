...
$fuppiConfig = [
    ...
    'session_persist_cookie_name' => 'fuppi_session_id_persist',
    'session_persist_cookie_lifetime' => intval(86400 * 30),
    'session_persist_cookie_domain' => $_SERVER['SERVER_NAME'],
    'session_persist_cookie_path' => '/',
    'settings' => [
        [
